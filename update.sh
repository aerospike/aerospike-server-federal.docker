...
sha256="$(curl -sSL "https://www.aerospike.com/artifacts/aerospike-server-federal/${fullVersion}/aerospike-server-federal-${fullVersion}-debian11.tgz.sha256" | cut -d' ' -f1)"
